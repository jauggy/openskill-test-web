...
import { splitOneChevs2 } from 'src/balanceAlgos/splitOneChevs2';
...
export const SplitOneChevsTab = (props: Props) => {
    ...
    useEffect(() => {
        const result = splitOneChevs2.rebalanceTeams(props.teams)
        setNewTeams(result)
    }, [props.teams])
    ...
    return (
        <View style={styles.container}>
            ...
            <AlgoDescriptionText algo={'split_one_chevs'} />
